...
class LoadModel {
  ...
  _Initialize() {
    ...
    const texture = loader.load([
      './resources/water_ft.jpg',
      './resources/water_bk.jpg',
      './resources/water_up.jpg',
      './resources/water_dn.jpg',
      './resources/water_rt.jpg',
      './resources/water_lf.jpg',
    ]);
  ...
  _LoadModel() {
    ...
    loader.load('./assets/ANGKONG_Tire1.1.glb', (gltf) => {
